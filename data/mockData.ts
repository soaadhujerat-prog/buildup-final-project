...
export const MOCK_WORKERS: Worker[] = [
  ...
  },
  {
    ...
    certifications: [{ name: 'קורס גבסנות מקצועי' }],
    preferredAreas: ['צפון'],
    isAvailable: true,
    hourlyRate: 100,
    dailyRate: 680,
  ...
  },
  {
    ...
    certifications: [{ name: 'קורס ריצוף מתקדם' }],
    preferredAreas: ['דרום'],
    isAvailable: true,
    hourlyRate: 105,
    dailyRate: 720,
...
export const MOCK_REGISTRATIONS: RegistrationRecord[] = [
  {
    ...
    data: {
      ...
      certifications: [{ name: 'חשמלאי מוסמך א׳' }],
      experienceYears: 4,
      preferredAreas: ['מרכז'],
      isAvailable: true,
      hourlyRate: 95,
